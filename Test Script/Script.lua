...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = "Overhaul (1.8 Test Version) Made by Unknownproooolucky",
    TabWidth = 160,
...
-- Функция для переключения гравитации
...
-- Сохраняем оригинальную гравитацию при загрузке
originalGravity = workspace.Gravity

-- Обновляем текст кнопки GUI при изменении состояния тумблера
